...
<template>
  <div class="hexbin-container">
    ...
    <v-chart :option="hexOption" autoresize style="width:100%;height:420px" />
    ...
    <div class="court-overlay">
      <svg viewBox="0 0 500 400" class="court-svg">
        ...
        <text x="250" y="210" text-anchor="middle" fill="rgba(255,255,255,0.04)" font-size="18">MID-COURT</text>
      </svg>
    </div>
...
.court-overlay { position: absolute; top: 40px; left: 16px; right: 16px; bottom: 36px; pointer-events: none; }
.court-svg { width: 100%; height: 100%; opacity: 0.5; }
