...
球员数据仅保留以下 12 位具有分析价值的标志性球员，过滤其余球员以减少 JSON 体积并简化选择列表：

| # | Player ID | 球员 | 叙事角色 |
|---|-----------|------|---------|
| 1 | 201939 | Stephen Curry | 三分革命符号 |
| 2 | 2544 | LeBron James | 跨时代巨星 |
| 3 | 893 | Michael Jordan | 90 年代统治者 |
| 4 | 977 | Kobe Bryant | 中距离大师 |
| 5 | 201935 | James Harden | 魔球极端代表 |
| 6 | 201142 | Kevin Durant | 中距离 + 三分全能 |
| 7 | 202691 | Klay Thompson | 接球就投射手范本 |
| 8 | 203081 | Damian Lillard | 超远三分先行者 |
| 9 | 406 | Shaquille O'Neal | 禁区统治者 |
| 10 | 2730 | Dwight Howard | 传统中锋对照 |
| 11 | 202695 | Kawhi Leonard | 中距离效率 + 稳定性 |
| 12 | 201572 | Brook Lopez | 禁区 → 空间型中锋转型 |

预处理脚本在聚合玩家数据时，只保留此白名单中的 12 名球员。球队数据仍保留全部 30 支球队。
